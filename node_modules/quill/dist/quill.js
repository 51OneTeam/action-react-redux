...
ImageTooltip = (function(superClass) {
  ...
  ImageTooltip.DEFAULTS = {
    template: [
      ...
      '<label class="image-label" for="image-upload">',
        '<div class="preview">',
          '<span>Preview</span>',
        '</div>',
  ...
  function ImageTooltip(quill, options) {
    ...
    oFReader.onload = function (oFREvent) {
      ...
      //document.querySelector('.input').value = oFREvent.target.result
      document.querySelector(".preview").value = oFREvent.target.result
      _this.textbox.value = oFREvent.target.result
      _this._preview()
      //document.querySelector(".preview").innerHTML = '<img src="' + oFREvent.target.result + '"/>'

    };
    dom(this.imageUpload).on('change', function (oFile) {
      var oFile = document.getElementById("image-upload").files[0]
  ...
  ImageTooltip.prototype._preview = function() {
    console.log('this.textbox.value:', this.textbox.value)
    var img;
